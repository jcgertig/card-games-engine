...
```bash
FULL_NAME="Jonathan Gertig"
GITHUB_USER="jcgertig"
REPO_NAME="@card-games-engine"
sed -i.mybak "s/\([\/\"]\)(ryansonshine)/$GITHUB_USER/g; s/typescript-npm-package-template\|my-package-name/$REPO_NAME/g; s/Jonathan Gertig/$FULL_NAME/g" package.json package-lock.json README.md
rm *.mybak
```
